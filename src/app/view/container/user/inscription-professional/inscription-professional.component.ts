...
@Component({
  selector: 'app-inscription-professional',
  templateUrl: './inscription-professional.component.html',
  styleUrls: ['./inscription-professional.component.scss']
})
export class InscriptionProfessionalComponent implements OnInit {
  errorMessage: any;
  seccussMessage: any;
  ...
  onSubmitUser(): void {
    ...
    if (this.addFormUser.controls['pwd1'].value == this.addFormUser.controls['pwd2'].value) {
      ...
      alert('verfieir les deux mots de passe ');
    }
  }
